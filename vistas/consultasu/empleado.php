...
<body>
    ...
    <div class="main">
        ...
        <section style="padding-left: 220px">
            <br>
            <h2>Consultas por empleado</h2>
            <form method="POST" action="">
                <div class="autocompletar">
                    <input type="search" name="consulta" placeholder="Nombre de empleado" class="consul" id="tipo-mascota" pattern="[^'\x22]+"></br>
                </div>
    ...
    <div id="tab">
        ...
        if (isset($_POST['send'])) {
            ...
            $user->verempleado($consulta);
            $user->verempleados($consulta);
            $user->verempleadodc($consulta);      
        }?>
        </div>
        </div>
        <br>
    ...
    <script type="text/javascript" src="../../js/consulta/empleado.js"></script>
</body>
</html>