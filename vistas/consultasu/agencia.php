...
<body>
    ...
    <div class="main" style="padding-left: 220px">
        <div class="cons">
        <section>
            <h2>Consultas por agencia</h2>
            <form method="POST" action="">
                <div class="autocompletar">
                <input type="search" name="consulta" placeholder="Agencias" class="consul" id="tipo-mascota" pattern="[^'\x22]+"></br>    
                </div>
    ...
    <div id="tab" >
        ...
        if (isset($_POST['send'])) {
            ...
            $user->vereagancia($consulta);
            $user->vereagencias($consulta);
            $user->veragenciadc($consulta);        
        }
        ?>
        </div>
        <br>
        Exportar a excel<br>
        <button onclick="exportTableToExcel('resultado', 'Reporte de equipos agencia')" style="width: 150px; background-color:none;" class='xpore'>Equipos</button> 
        <button onclick="exportTableToExcel('resultado1', 'Reporte de software agencia')" style="width: 150px;" class='xpore'>Software</button> 
        <button onclick="exportTableToExcel('resultado3', 'Reporte de dispositivo agencia')" style="width: 150px;" class='xpore'>Dispositivos</button>    
    </div>
</section>
    ...
    <script type="text/javascript" src="../../js/consulta/agencia.js"></script>
</body>
</html>