	...
	<div class="container-fluid">
	  <div class="row">
	    ...
	    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-5 align-items-center"> 
	        ...
	        <h1 class="h2">Datos del la consulta</h1>
	      	</div>
	      	<div class="form w-75">
	      		<div class="form-group row">
			    	<label class="col-sm-2 col-form-label h4">Tecnico:</label>
			    	<div class="col-sm-10">			    
				...
				<div class="form-group row">
					<div class="sticky-top col-sm-10">
						<input class="btn float-right text-white bg-colua" type="button" value="Consultar" onclick="consule()">  
					</div>
				</div>
			</div>
			<div class="table-responsive-sm" id="usin">
