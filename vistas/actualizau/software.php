	    ...
	    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-5 align-items-center"> 
	        ...
	        <h1 class="h2">Datos de empleado</h1>
	      	...
	      	<div class="form w-75">
				...
				<h2 class="h3">Datos de empleado</h2>
				<div class="form-group row">
				    <label class="col-sm-2 col-form-label h4">Software:</label>
				    <div class="col-sm-10">
				...
				<div class="form-group row">
					<div class="sticky-top col-sm-12">
						<input class="btn float-right text-white bg-colua mx-2" type="button" value="Actualizar" onclick="upsof()">
				    	<input class="btn float-right text-white bg-colua" type="button" value="Agregar nuevo" onclick="savesof()">	
					</div>
				</div>
				<?php 
