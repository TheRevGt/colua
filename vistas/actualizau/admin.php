...
<body>
	...
	<div class="container-fluid">
	  <div class="row">
	    ...
	    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-5 align-items-center"> 
	        ...
	        <h1 class="h2">Actualizar área</h1>
	      	</div>
	      	<div class="form w-75">
	      		<div class="form-group row">
			    	<label class="col-sm-2 col-form-label h4">Área:</label>
			    	<div class="col-sm-10">
			      		<select class="form-control" id="n_are" onchange="veremplesa()">
	      		...
	      		<div class="form-group row">
			    	<label class="col-sm-2 col-form-label h4">Nombre del área:</label>
			    	<div class="col-sm-10">
			      		<input type="text" type="text" class="form-control" id="db_nombre" placeholder="Area *">
			    	</div>
				</div>
				<div class="form-group row">
					<div class="sticky-top col-sm-10">
						<input class="btn float-right text-white bg-colua" type="button" value="Actualizar" onclick="uparea()">  
					</div>
				</div>
			</div>
	...
	<script type="text/javascript" src="../../js/update/setare.js"></script>
	<script type="text/javascript" src="../../js/info/iareacu.js"></script>
</body>
</html>