...
<body>
	...
	<nav class="nav sticky-top flex-md-nowrap p-0 shadow bg-light align-items-center">
	    ...
	    <main role="main" class="col-md-10 ml-sm-auto px-md-5 align-items-center"> 
	        ...
	        <h1 class="h2">Actualizar usuario del sistema</h1>
	      	</div>
	      	<form class="form w-75" method="POST">
	      		<div class="form-group row">
			    	<label class="col-sm-3 col-form-label h4">Seleccionar usuario:</label>
			    	<div class="col-sm-9">
			      		<select class="form-control" id="anuser" onclick="envem()" name="auser">
							<?php
								$user->verus();
							?>
						</select>
	      		...
	      		<div class="form-group row">
			    	...
			    	<div class="col-sm-9">
			      		<input type="text" id="1" class="form-control" name="areg_user" placeholder="Usuario *" required="true">
			    	</div>
				</div>
				<div class="form-group row">
			    	<label class="col-sm-3 col-form-label h4">Nombre:</label>
			    	<div class="col-sm-9">
			      		<input type="text" id="2" class="form-control" name="areg_nom" placeholder="Nombre *" required="true">
			    	</div>
				</div>
				<div class="form-group row">
			    	<label class="col-sm-3 col-form-label h4">Contraseña:</label>
			    	<div class="col-sm-9">
			      		<input type="text" id="3" class="form-control" name="areg_pas" placeholder="Contraseña *" required="true">
			    	</div>
				</div>
				<div class="form-group row">
			    	<label class="col-sm-3 col-form-label h4">Correo:</label>
			    	<div class="col-sm-9">
			      		<input type="text" id="4" class="form-control" name="aemail" placeholder="Correo *" required="true">
			    	</div>
				</div>
				<div class="form-group row">
					<div class="sticky-top col-sm-10">
						<input class="btn float-right text-white bg-colua" type="submit" value="Actualizar">  
					</div>
				</div>
			</form>
			<?php
    		...
    		<div class="consular col-sm-12">
		        ...
		        echo "</table>";
				?>
			<button onclick="exportTableToExcel('cons', 'Áreas')" class='btn float-right text-white bg-export'>Guardar <span data-feather="file"></button> 
    		</div>
	      </div>
	    </main>
	  </div>
