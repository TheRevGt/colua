...
<!-- Nav-->
    ...
    <?php include_once '../../includes/user.php'; $user = new User(); ?>
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-5 align-items-center"> 
            ...
            <h1 class="h2">Consulta por agencia</h1>
            </div>
            <form class="form w-75" method="POST">
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label h4">Numero de activo:</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="search" name="consulta" id="tipo-mascota" placeholder="Agencia" class="consul" pattern="[^'\x22]+">
                    </div>
                </div>
                <div class="form-group row">
            ...
            <div class=" align-items-center">
                ...
                <button onclick="exportTableToExcel('resultado1', 'Reporte de software de equipo')" class='btn text-white bg-export'>Guardar software <span data-feather="code"></button>
