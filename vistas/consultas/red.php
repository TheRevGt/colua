...
<body>
    ...
    <?php include_once '../../includes/user.php'; $user = new User(); ?>
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-5 align-items-center"> 
            ...
            <h1 class="h2">Consulta por estado dispositivos de red</h1>
            </div>
            ...
            <div class=" align-items-center">
                <button onclick="exportTableToExcel('resultado', 'Reporte de equipo')" class='btn text-white bg-export'>Guardar dispositivo <span data-feather="server"></button>
