          ...
          <div class="sidebar-sticky pt-5">
            <ul class="nav flex-column">
              <li class="nav-item pb-2">
	              <a class="nav-link active" href="general.php">
    ...
    <?php include_once '../../includes/user.php'; $user = new User(); ?>
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-5 align-items-center"> 
            ...
            <div class=" align-items-center">
              <form method="POST">
                <button type="submit" name='equipoExport' class='btn text-white bg-export'>Exportar<span data-feather="monitor"></button>
              </form>
            ...
            <?php
            if (isset($_POST['equipoExport'])) { 
              $user->vergeneral();
              echo '<script type="text/JavaScript">
              exportTableToExcel("resultado", "Reporte de equipo");
              var node = document.getElementById("resultado");
              node.parentNode.removeChild(node);
              </script>';
              unset($_POST['equipoExport']);
            }
            ?>
          </div>
        </main>
