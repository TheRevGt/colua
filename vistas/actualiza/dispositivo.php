	...
	<div class="container-fluid">
	  <div class="row">
	    ...
	    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-5 align-items-center"> 
	        ...
	        <h1 class="h2">Datos de empleado</h1>
	      	</div>
	      	<div class="form w-75">
	      		<div class="form-group row">
			    	<label class="col-sm-2 col-form-label h4">Empleado:</label>
			    	<div class="col-sm-10">
			      		<select class="form-control" id="d_nombre" onclick="dispoex()">
								<?php
								$user->veremple();
								?>					
				...
				<div class="form-group row">
			    	...
			    	<div class="col-sm-10">
			      		<select class="form-control" id="disex" onclick="dispoac()">
						
						</select>
			    	</div>
				</div>
				<div class="form-group row">
			    	<label class="col-sm-2 col-form-label h4">Nombre dispositivo:</label>
			    	<div class="col-sm-10">
				...
				<div class="form-group row">
			    	...
			    	<div class="col-sm-10">
			      		<input type="checkbox" class="form-check-input" id="estedis" value="Inactivo">
			    	</div>
				</div>
				<div class="form-group row">
					<div class="sticky-top col-sm-10">
						<input class="btn float-right text-white bg-colua" type="button" value="Actualizar" onclick="updispo()">
					</div>
				</div>
			</div>
