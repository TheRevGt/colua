	        ...
	        <h1 class="h2">Registrar Empleado</h1>
	      	...
	      	<div class="form w-75">
	      		<div class="form-group row">
			    	...
			    	<div class="col-sm-10">
			      		<select class="form-control" id="n_agenc">
				...
				<div class="form-group row">
			    	...
			    	<div class="col-sm-10">
			      		<select class="form-control" id="n_are">
				...
				<div class="form-group row">
				    ...
				    <div class="col-sm-10">
				    	<input type="text" class="form-control" id="db_nom" placeholder="Nombre del empleado">
				    </div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
				    ...
				    <div class="col-sm-10">
				    	<input type="text" class="form-control" id="db_pas" placeholder="Contraseña">
				    </div>
				</div>
				<div class="form-group row">
					<div class="sticky-top col-sm-10">
						<input class="btn float-right text-white bg-colua" type="button" value="Registrar" onclick="savedemple()">  
					</div>
				</div>
			</div>
